                ...
                while(tt != 1 && tt != 2){
                    ...
                    switch(tt){
                        case 1:
                            ...
                            int index2 = dsYCDK.indexOf(dsYCTD.get(index).getLTH());
                            dsYCDK.get(index2).setMaCaThucHanh(dsYCTD.get(index).getMaCaTHmoi());
                            dsYCDK.get(index2).setMaPhongThucHanh(dsYCTD.get(index).getMaPTHmoi());
                            dsYCDK.get(index2).setNgayBatDau(dsYCTD.get(index).getNgayTHmoi());
                            dsYCDK.get(index2).setSoTuan(dsYCTD.get(index).getSoTuan());
