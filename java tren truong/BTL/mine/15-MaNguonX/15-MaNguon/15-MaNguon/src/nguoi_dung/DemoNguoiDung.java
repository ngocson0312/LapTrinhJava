...
//        ArrayList<LopHoc> x = new ArrayList<>();
//        x.add(new LopHoc("1", "2022IT6001", 50, new MonHoc("1", "Java", "KTPM"), ""));
//        x.add(new LopHoc("2", "2022IT6002", 55, new MonHoc("2", "Android", "KTPM"), ""));
//        acc.get(1).setDsLopHoc(x);
//        ArrayList<LopHoc> y = new ArrayList<>();
//        y.add(new LopHoc("3", "2022IT6005", 55, new MonHoc("1", "Java", "KTPM"), ""));
//        y.add(new LopHoc("4", "2022IT6008", 55, new MonHoc("2", "Android", "KTPM"), ""));
//        acc.get(2).setDsLopHoc(y);  
//        try {
//            db.LuuFile("data/DSTK.txt", acc);
//        } catch (Exception ex) {
//            Logger.getLogger(DemoNguoiDung.class.getName()).log(Level.SEVERE, null, ex);
