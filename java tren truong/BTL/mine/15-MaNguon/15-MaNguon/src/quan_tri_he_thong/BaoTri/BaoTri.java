...
public class BaoTri {
    ...
    public static ArrayList<LichThucHanh> listLTH = new ArrayList<LichThucHanh>();
    static Database data = new Database();
    static String linkPTH = "data/pth.txt";
    static String linkLTH = "data/lth.txt";
    ...
    public static void menuBaoTri(){
         ...
         if((new File(linkLTH).exists())){
             try {
                 listLTH = (ArrayList<LichThucHanh>) data.docFile(linkLTH);
             } catch (Exception ex) {
                 java.util.logging.Logger.getLogger(BaoTri.class.getName()).log(Level.SEVERE, null, ex);
             }
