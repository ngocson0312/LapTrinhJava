...
//Xây dựng chức năng quản trị tài khoản giáo viên
    ...
    //Xây dựng chức năng thêm tài khoản 
    ...
    //Xây dựng chức năng sửa trạng thái tài khoản
    ...
    // Xây dựng chức năng xóa tài khoản
    ...
    //Xây dựng chức năng hiển thị thông tin tài khoản
    public static void xem(int loai){
        int dem = 0;
        // Hiện thị tài khoản giáo viên
        if(loai == 1){
            System.out.println("\n---------------------------------------------------------------------------------------------");
            System.out.println("\n------------- TÀI KHOẢN GIÁO VIÊN -------------");
            TaiKhoan.tieuDe();
        ...
        // Hiện thị tài khoản quản trị viên
        else if(loai == 2){
            System.out.println("\n---------------------------------------------------------------------------------------------");
    ...
    // Kiểm tra tồn tại của tài khoản trong danh sách
...
//Xây dựng chức năng quản trị tài khoản quản trị viên
    public static void taskQLTKQTV(){
        
        // Kiểm tra chỉ cho phép trưởng khoa hoặc tài khoản đặc biệt dùng chức năng này
